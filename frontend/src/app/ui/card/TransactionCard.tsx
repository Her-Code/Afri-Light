  ...
  return (
    ...
    <section className="mb-6">
        <div className="flex items-center justify-between">
            ...
            <a href="/transaction" className="text-blue-600 hover:underline">
            View All
            </a>
        </div>
        <p className="text-gray-500 mt-2">Your latest transactions</p>
    </section>


      <div className="border p-4 rounded-md border-gray-300 pt-6">
